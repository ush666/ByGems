...
// Fetch services under "Amenities" category with active status
$sql = "SELECT * FROM services WHERE category = 'Amenities' AND status = 'enabled'";
    ...
    <div class="container py-5" style="padding-top: 100px !important;">
        ...
        <div class="card-container">
            <?php if (empty($servicess)): ?>
                <p class="text-muted">No Amenities available right now.</p>
            <?php else: ?>
