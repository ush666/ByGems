...
// Fetch services under "Cakes" category with active status
$sql = "SELECT * FROM services WHERE category = 'Cakes' AND status = 'enabled'";
    ...
    <div class="container py-5" style="padding-top: 100px !important;">
        ...
        <div class="card-container">
            <?php if (empty($servicess)): ?>
                <p class="text-muted">No Cakes available right now.</p>
            <?php else: ?>
