...
<html lang="en">
    ...
    <body>
        ...
        <!-- Hero Carousel -->
        <section id="heroCarousel" class="carousel slide carousel-fade" data-bs-ride="carousel" data-bs-interval="3000"
            data-bs-pause="hover">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="cta-card mb-4">
                            <div class="d-flex align-items-center">
                                <div class="me-3 fs-4">
                                    <ion-icon class="text-warning" name="sparkles"></ion-icon>
                                </div>
                                <div>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            var calendar = new FullCalendar.Calendar(calendarEl, {
                ...
                height: 500,
                contentHeight: 'auto',
                events: '../events/fetch_events_home.php', // Fetch events dynamically
