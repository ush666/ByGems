...
<html lang="en">
    ...
    <head>
        ...
        <title>ByGems Party Services</title>
    ...
    <body>
        ...
        <!-- Hero Carousel -->
        <section id="heroCarousel" class="carousel slide" data-bs-ride="carousel" style="padding-top: 55px;">
            <div class="carousel-inner">
                ...
                <div class="carousel-item">
                    <img src="../img/landing-page.png" class="d-block w-100" alt="Party Image 2">
                </div>
                <div class="carousel-item">
                    <img src="../img/landing-page.png" class="d-block w-100" alt="Party Image 3">
                </div>-->
            </div>
